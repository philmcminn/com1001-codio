This respository contains a script to install a series of files and an initial set of gems to make it easier for students to develop Sinatra applications on Codio. 
